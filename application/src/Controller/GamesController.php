...
use Main\Form\Games\CreateGame;
use Main\Model\Game;
    ...
    public function indexAction()
    {
        ...
        switch ($game->getCurrentStatus()) {
            case Game::STATUS_WAITING:
                return $this->render('setup', $this->setupGame($game));

            case Game::STATUS_STARTED:
                return !empty($player)
                    ? $this->render('play', $this->playGame($game, $player))
                    : $this->render('spectate', $this->spectateGame($game));

            case Game::STATUS_FINISHED:
                return $this->render('finished', $this->finishedGame($game));
