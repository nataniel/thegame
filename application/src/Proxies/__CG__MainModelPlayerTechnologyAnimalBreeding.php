 ...
 */
class AnimalBreeding extends \Main\Model\Player\Technology\AnimalBreeding implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AnimalBreeding $proxy) {
