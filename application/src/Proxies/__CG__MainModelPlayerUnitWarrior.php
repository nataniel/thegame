...
namespace Main\Proxies\__CG__\Main\Model\Player\Unit;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Warrior extends \Main\Model\Player\Unit\Warrior implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Warrior $proxy) {
    ...
    public function maxAmount()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'maxAmount', []);
    ...
    public function canBeRecruited($amount = 1)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'canBeRecruited', [$amount]);

        return parent::canBeRecruited($amount);
    }
    ...
    public function recruit($amount = 1)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'recruit', [$amount]);

        return parent::recruit($amount);
    }
